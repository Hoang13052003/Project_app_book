...
public class BookRecyclerAdapterHorizental extends RecyclerView.Adapter<BookRecyclerAdapterHorizental.ViewHolder> {
    ...
    public BookRecyclerAdapterHorizental(Context context, ArrayList<Book> bookList, int layoutResource) {
